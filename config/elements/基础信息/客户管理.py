...
客户编辑="xpath==//div[@class='ant-table-fixed-right']//tbody/tr[1]/td[1]//a[1]"
客户删除="xpath==//div[@class='ant-table-fixed-right']//tbody/tr[1]/td[1]//a[2]"
合并重名客户="xpath==//button/span[text()='合并重名客户']/.."
客户档案导出Excel="xpath==//button/span[text()='导出Excel']/.."
客户档案搜索框="xpath==//input[@placeholder='名称/联系电话']"
客户档案搜索按钮="xpath==//span[@class='ant-input-suffix']"
客户向下展开按钮="xpath==//a[text()='高级搜索']"
客户向上展开按钮="xpath==//a[text()='收起搜索']"
高级搜索按钮="xpath==//button/span[text()='搜 索']/.."
高级搜索重置="xpath==//button/span[text()='重 置']/.."
选择管理区="id==regionId"
管理区数据="xpath==//ul[@role='listbox']/li[1]"
客户名称="id==name"
客户性别男="xpath==//div[@id='sex']/label[1]/span[1]"
客户档案保存="xpath==//div[@class='ant-modal-footer']/button[2]"
表格中管理区数据="xpath==//tbody/tr[1]/td[1]//input"
...
客户名称断言="xpath==//tbody/tr[1]/td[4]/span"
...
委员会确定="xpath==//div[@class='ant-modal-footer']//button[2]"
委员会取消="xpath==//div[@class='ant-modal-footer']//button[1]"
